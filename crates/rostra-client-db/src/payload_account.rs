...
use crate::{Database, PayloadAdmissionPause, PayloadAllocation};
...
impl PayloadAccount {
    ...
    /// limits are configured, capacity exhaustion returns a temporary admission
    /// pause; successful ownership must remain alive through the covered bytes.
